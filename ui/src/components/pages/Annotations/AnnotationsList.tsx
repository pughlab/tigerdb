...
import { Button, Form, Header, Label, Input, Segment, Container, Message, List, Divider, Modal, Grid, Dropdown, Icon } from 'semantic-ui-react'
        ...
        <>
            <Container>
                <Message>
                    ...
                    <Button fluid size='large' color='black' animated='vertical' onClick={() => console.log("clicked")}>
