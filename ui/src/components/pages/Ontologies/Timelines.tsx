...
export default function TimelineOntologies () {
  ...
  return (
    ...
    <Segment attached='top'>
        <Divider horizontal content='Timelines' />
        <Message>
          Every study has a timeline. Each timeline is an ordered set of data collection timepoints.
          You can query across timepoints across studies in the explore database page.
          <Divider horizontal />
